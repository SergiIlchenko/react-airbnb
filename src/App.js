...
import PropertiesList from "./component/properties_list";
import GuestReviews from "./component/guest_reviews";
import NearbyAttractions from "./component/nearby_attractions";
  ...
  return (
    <Page>
      ...
      <Amenities
        ...
        breackfast={data.amenities.hasFreeBreakfast}
